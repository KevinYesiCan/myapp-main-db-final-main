...
def toppick(request, id):
    ...
    movies = {
        ...
        5: {
            ...
            'actors': [
                {'name': 'Betsy Palmer', 'image': '13info1.jpg'},
                {'name': 'Adrienne King', 'image': '13info2.png'},
                {'name': 'Jeannine Taylor', 'image': '13info3.jpg'},
                {'name': 'Robbi Morgan', 'image': '13info4.jpg'},
                {'name': 'Kevin Bacon', 'image': '13info5.jpg'},
                {'name': 'Harry Crosby', 'image': '13info6.jpg'},
                {'name': 'Laurie Bartram', 'image': '13info7.jpg'},
                {'name': 'Mark Nelson', 'image': '13info8.jpg'},
                {'name': 'Renee Jones ', 'image': '13info9.jpg'},
                {'name': 'Peter Browning', 'image': '13info10.jpg'},
            ]
        },
        6: {
            'title': '9Sadtra',
            ...
            'actors': [
                {'name': 'กนกฉัตร มรรยาทอ่อน', 'image': '9info1.jpg'},
                {'name': 'วรฤทธิ์ เฟื่องอารมย์', 'image': '9info2.jpg'},
                {'name': 'สาวิตรี สุทธิชานนท์', 'image': '9info6.jpg'},
                {'name': 'รัชพล แย้มแสง', 'image': '9info4.jpg'},
                {'name': 'ศิริชัย เจริญกิจธนกุล', 'image': '9info5.jpg'},
            ]
        },
    }
